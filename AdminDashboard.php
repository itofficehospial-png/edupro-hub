...
// Total Projects
$resultProjects = $conn->query("SELECT COUNT(*) AS total FROM projects");
$totalProjects = ($resultProjects && $row = $resultProjects->fetch_assoc()) ? $row['total'] : 0;

// Total Supervisors
$resultSupervisors = $conn->query("SELECT COUNT(*) AS total FROM supervisors");
